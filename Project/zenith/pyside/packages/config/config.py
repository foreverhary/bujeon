...
from packages.resources.string import CONFIG_FILE_NAME, POP_SECTION, ORDER_NUMBER_CONFIG, MSSQL_SECTION, \
...
def get_order_number():
    return get_config_value(CONFIG_FILE_NAME, POP_SECTION, ORDER_NUMBER_CONFIG)


def set_order_number(value):
    set_config_value(CONFIG_FILE_NAME, POP_SECTION, ORDER_NUMBER_CONFIG, value)
...
class Config:
    ...
    def init_config(self):
        ...
        config[POP_SECTION][ORDER_NUMBER_CONFIG] = ''

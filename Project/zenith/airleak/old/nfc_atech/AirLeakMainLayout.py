...
from process_package.component.CustomComponent import Button, LineEdit, Label, ComboBox
from process_package.old.defined_serial_port import ports
from process_package.old.defined_variable_function import DM_FONT_SIZE, DM_LABEL_WIDTH_SIZE

...
class Ui_SplashScreen(object):
    def setupUi(self, SplashScreen, app_name):
...
"color: rgb(155, 155, 255);")
        ...
        self.retranslateUi(SplashScreen, app_name)

        QMetaObject.connectSlotsByName(SplashScreen)
    # setupUi

    def retranslateUi(self, SplashScreen, app_name):
        SplashScreen.setWindowTitle(QCoreApplication.translate("SplashScreen", u"MainWindow", None))
        self.labelTitle.setText(QCoreApplication.translate("SplashScreen", f"<html><head/><body><p><span style=\" font-weight:600; color:#9b9bff;\"></span> {app_name}</p></body></html>", None))
        ...
        self.labelLoadingInfo.setText(QCoreApplication.translate("SplashScreen", "loading...", None))

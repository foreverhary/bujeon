...
class MinMaxFrame(QFrame):
    ...
    def setpotnum(self, pot_num, minmax):
        ...
        self.minmaxLabel.setText(f'{self.minmax.upper()}:')
        self.minmaxValue.setText(convertValueToStr(self.config.getValue(self.pot_name, (CONFIG_MIN, CONFIG_MAX)['max' in self.minmax.lower()])))
